   ...
   const handleSubmit = async (e)=>{
    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form className='flex flex-col sm:flex-row gap-4' onSubmit={handleSubmit}>
            ...
            <button disabled={loading || upload} className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80 mt-3'>{loading ? 'Updating...' : 'Update listing'}</button>
